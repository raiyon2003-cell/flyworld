      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col gap-12 px-4 sm:px-6 lg:flex-row lg:items-center lg:gap-16 lg:px-8">
        <div className="max-w-3xl flex-1">
          ...
          >
            ...
            Exclusive Last-Minute Deals — Updated Daily
          </motion.div>
          ...
          >
            Discover extraordinary journeys at unbeatable prices. Sun-kissed beaches
            to vibrant city escapes — your next adventure is one click away.
          </motion.p>
